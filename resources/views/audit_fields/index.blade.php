...
<div class="container mt-4">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            @forelse ($fields as $index => $field)
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('audit-fields.destroy', [$client->id, $field->id]) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this field?')">
                            @csrf
            ...
            @empty
                <tr><td colspan="7" class="text-center">No fields found.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
